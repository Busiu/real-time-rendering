...
protected:
    ...
    GLuint shaderProgram, shaderProgramShadow, shaderProgramHDR;
    GLuint VAO, VAO_light, VAO_floor, VAO_screen;
    GLuint tex_color, tex_color_floor, tex_FBO_depth, tex_FBO_HDR_color, tex_FBO_HDR_depth; // !!!
    GLuint FBO, FBO_HDR;
