...
private slots:
    ...
    void on_verticalSliderInner_valueChanged(int);
    void on_verticalSliderOuter0_valueChanged(int);
    void on_verticalSliderOuter1_valueChanged(int);
    void on_verticalSliderOuter2_valueChanged(int);
