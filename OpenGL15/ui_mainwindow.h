...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalSliderRotX->setMaximum(360);
        ...
        verticalSliderRotZ->setMaximum(360);
        ...
        verticalSliderRotY->setMaximum(360);
        ...
        verticalSliderZoom->setMaximum(100);
        verticalSliderZoom->setValue(10);
