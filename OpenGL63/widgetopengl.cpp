...
#define MODEL "dragon" // dragon texcube
#define TEXTURE "wood2" // wood2 dragonskin
...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        QImage tex("../Modele/" TEXTURE ".jpg");
        if (tex.byteCount() == 0) throw QString("Nie udalo sie wczytac tekstury");
...
void WidgetOpenGL::paintGL()
{
    ...
    try
    {
        ...
        glBindTexture(GL_TEXTURE_2D, tex_color);
        int attr_tex = getUniformLocation(shaderProgram, "textureBitmap");
        ...
        int attr_outline = getUniformLocation(shaderProgram, "outline");
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            // Enabling GL_STENCIL_TEST is very important step !!!
            if (i % 2 == 0)
            {
...
void WidgetOpenGL::change_border_thickness(float _thickness)
{
