    ...
    ui(new Ui::MainWindow)
{
    ...
    setWindowTitle("OpenGL 63 (stencil buffer)");
}
...
{
    ui->widgetOpenGL->change_border_thickness(ui->verticalSliderBorder->value()*0.1);
}

void MainWindow::on_verticalSliderBorder_valueChanged(int)
{
