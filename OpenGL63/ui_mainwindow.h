...
public:
    ...
    QSlider *verticalSliderBorder;

    void setupUi(QMainWindow *MainWindow)
    {
        if (MainWindow->objectName().isEmpty())
            MainWindow->setObjectName(QString::fromUtf8("MainWindow"));
        MainWindow->resize(1003, 595);
        ...
        verticalSliderBorder = new QSlider(horizontalGroupBox);
        verticalSliderBorder->setObjectName(QString::fromUtf8("verticalSliderBorder"));
        verticalSliderBorder->setMinimum(10);
        verticalSliderBorder->setMaximum(100);
        verticalSliderBorder->setValue(30);
        verticalSliderBorder->setOrientation(Qt::Vertical);

        horizontalLayout_3->addWidget(verticalSliderBorder);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        horizontalGroupBox->setTitle(QCoreApplication::translate("MainWindow", "Obw\303\263dka", nullptr));
    } // retranslateUi
