...
public:
    ...
    QGroupBox *groupBoxSSAO;
    QHBoxLayout *horizontalLayout_3;
    QSlider *verticalSliderKernelRadius;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBoxSSAO = new QGroupBox(centralWidget);
        groupBoxSSAO->setObjectName(QString::fromUtf8("groupBoxSSAO"));
        horizontalLayout_3 = new QHBoxLayout(groupBoxSSAO);
        horizontalLayout_3->setSpacing(6);
        horizontalLayout_3->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_3->setObjectName(QString::fromUtf8("horizontalLayout_3"));
        verticalSliderKernelRadius = new QSlider(groupBoxSSAO);
        verticalSliderKernelRadius->setObjectName(QString::fromUtf8("verticalSliderKernelRadius"));
        verticalSliderKernelRadius->setMinimum(4);
        verticalSliderKernelRadius->setMaximum(30);
        verticalSliderKernelRadius->setValue(10);
        verticalSliderKernelRadius->setOrientation(Qt::Vertical);

        horizontalLayout_3->addWidget(verticalSliderKernelRadius);


        gridLayout->addWidget(groupBoxSSAO, 0, 7, 2, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBoxSSAO->setTitle(QCoreApplication::translate("MainWindow", "ssao", nullptr));
    } // retranslateUi
