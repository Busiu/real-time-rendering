...
protected:
    ...
    GLuint shaderProgram_Shading, shaderProgram_ShadowMap, shaderProgram_HDR, shaderProgram_Filter, shaderProgram_gBuffer;
    GLuint VAO, VAO_shadow, VAO_light, VAO_floor, VAO_screen;
    GLuint tex_color, tex_normal, tex_normal_floor, tex_color_light, tex_color_floor, tex_FBO_depth, tex_FBO_HDR_color[2], tex_FBO_HDR_depth, tex_FBO_filter[2];
    GLuint tex_FBO_gBuffer_position, tex_FBO_gBuffer_normal, tex_FBO_gBuffer_color, tex_FBO_gBuffer_depth;
    GLuint FBO, FBO_gBuffer, FBO_HDR, FBO_filter[2];
