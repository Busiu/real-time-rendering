...
#define MODEL   "texcube"
#define TEXTURE "wood3"
...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        tex_specular = loadTexture2D("../Modele/" TEXTURE "_specular2.jpg"); // !!!
...
void WidgetOpenGL::paintGL()
{
    ...
    try
    {
        ...
        int attr_tex = getUniformLocation(shaderProgram, "textureColor");
        glUniform1i(attr_tex, 0);

        glActiveTexture(GL_TEXTURE1);
        glBindTexture(GL_TEXTURE_2D, tex_specular);
        attr_tex = getUniformLocation(shaderProgram, "textureSpecular");
