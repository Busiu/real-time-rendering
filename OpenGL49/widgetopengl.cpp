...
#define MODEL         "tree-no-leaves.obj"
#define MODEL_TRANS   "tree-only-leaves.obj"
#define MODEL_FLOOR   "plane.obj"
#define TEXTURE       "tree2.png"
#define TEXTURE_FLOOR "asfalt.jpg" // stones2 bricks2
...
GLuint WidgetOpenGL::loadTexture2D(QString fname, int clamp_mode)
{
    QImage tex(fname);
...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        ////////////////////////////////////////////////////////////////
        // Vertex Buffer Object + Vertex Array Object (transparent)
        ////////////////////////////////////////////////////////////////

        // tworzymy VBO i przesylamy dane do serwera OpenGL
        glGenBuffers(1, &VBO);
        glBindBuffer(GL_ARRAY_BUFFER, VBO);
        glBufferData(GL_ARRAY_BUFFER, model_transparent.getVertDataSize(), model_transparent.getVertData(), GL_STATIC_DRAW);

        // tworzymy VAO
        glGenVertexArrays(1, &VAO_transparents);
        glBindVertexArray(VAO_transparents);
        ...
        ////////////////////////////////////////////////////////////////
        // Vertex Buffer Object + Vertex Array Object (podloga)
        ////////////////////////////////////////////////////////////////
...
//        glCullFace(GL_BACK);
        ...
        /*
         * Z tego co widzę to udało się to zrobić!
         */
        glBlendFuncSeparate(GL_SRC_ALPHA, GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
...
void WidgetOpenGL::paintGL()
{
    ...
    try
    {
        ...
        glBindFramebuffer(GL_FRAMEBUFFER, FBO);
        makeShadowMatrix();
        paintScene(true, false);
        paintScene(true, true);
...
void WidgetOpenGL::paintScene(boolean gen_shadow_map, boolean paint_transparents)
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        m_matrix.scale(1.0, f_rand(0.8, 1.2), 1.0);
        m_matrix.rotate(f_rand(0.0, 360.0), 0, 1, 0);
        ...
        glDrawArrays(GL_TRIANGLES, 0, 3*(paint_transparents ? triangles_transparent_cnt : triangles_cnt));
    }

    if (!gen_shadow_map && !paint_transparents)
    {
        // podloga...
        glBindVertexArray(VAO_floor);
