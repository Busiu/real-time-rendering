...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        Model model;
        model.readFile("../Modele/sphere2.obj", true, false, 0.4);
...
void WidgetOpenGL::paintGL()
{
    ...
    try
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            m_matrix.rotate(36*i + walk_angle, 0, 1, 0); //!!!
            m_matrix.translate(0, 0, -2);
            m_matrix.scale(0.5);

            // !!!
            float s = qSin(3.1415926*(10*(walk_angle+10*i))/180.0)*0.2 + 1;
            m_matrix.scale(s, 1/s, 1);
...
{
    if (++walk_angle > 360) walk_angle -= 360;
    repaint();
}
