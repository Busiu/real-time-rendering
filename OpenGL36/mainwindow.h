...
private slots:
    ...
    void on_verticalSliderGamma_valueChanged(int value);
    void on_horizontalSlider_Slider_valueChanged(int value);
    void on_verticalSliderLightB_valueChanged(int value);

    void on_verticalSliderGaussianRadius_valueChanged(int);
