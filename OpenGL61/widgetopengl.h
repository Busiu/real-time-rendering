...
protected:
    ...
    GLuint shaderProgram_gbuffer, shaderProgram_shading;
    GLuint VAO, VAO_light, VAO_screen;
    GLuint tex_color, tex_color_light;
    int selected_object;

    GLuint FBO_gBuffer;
    GLuint tex_FBO_gBuffer_position, tex_FBO_gBuffer_normal, tex_FBO_gBuffer_color, tex_FBO_gBuffer_depth, tex_FBO_gBuffer_id;
