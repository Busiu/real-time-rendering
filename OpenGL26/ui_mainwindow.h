...
public:
    ...
    QSlider *verticalSliderRefraction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalSliderRefraction = new QSlider(horizontalGroupBox);
        verticalSliderRefraction->setObjectName(QString::fromUtf8("verticalSliderRefraction"));
        verticalSliderRefraction->setMaximum(100);
        verticalSliderRefraction->setOrientation(Qt::Vertical);

        horizontalLayout_3->addWidget(verticalSliderRefraction);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        horizontalGroupBox->setTitle(QCoreApplication::translate("MainWindow", "Za\305\202amanie", nullptr));
    } // retranslateUi
