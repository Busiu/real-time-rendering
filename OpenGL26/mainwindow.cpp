...
void MainWindow::change_refraction()
{
    ui->widgetOpenGL->change_refraction(ui->verticalSliderRefraction->value()*0.01);
}

void MainWindow::on_verticalSliderRefraction_valueChanged(int)
{
    change_refraction();
}
