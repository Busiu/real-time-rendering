...
#define MODEL          "dragon" // dragon sphere rcube
...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        // wspolrzene wierzcholkow
        attr = getAttribLocation(shaderProgramSkybox, "position");
...
void WidgetOpenGL::paintGL()
{
    ...
    try
    {
        ...
        // refraction
        int attr_refract = getUniformLocation(shaderProgram, "refractionRatio");
        glUniform1f(attr_refract, refraction);

        // material...
        Material material(1.0,  1.0,   1.0,    0.0, // ambient
                          1.0,  1.0,   1.0,    0.0, // diffuse
...
void WidgetOpenGL::change_refraction(float _refraction)
{
