...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        /*
         * Test głębokości sprawia, iż renderowane są tylko te fragmenty, które faktycznie zauważylibyśmy w prawdziwym życiu -
         * - jeżeli jakiś fragment A byłby zasłaniany przez fragment B to w prawdziwym życiu ujrzelibyśmy tylko fragment B.
         *
         * Gdy wyłączymy test głębokości rysowane są wszystkie fragmenty, przez co niektóre z nich będą "nadpisywane". Stracimy
         * tak zwaną głębokość (z-index dla osób które coś tam robiły w CSS). Widzimy też, iż fragmenty ciała smoka, które
         * znajdują się po stronie która powinna być dla nas niewidoczna są dla nas jak najbardziej widoczne. Najlepiej to widać
         * w miejscach, w których normalne pokrywających się fragmentów nie są "bardzo do siebie równoległe" czyli np. w zgięciach
         * nóg, czy na ustach (paszczy)
         */
