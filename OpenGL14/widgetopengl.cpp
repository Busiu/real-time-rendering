...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        glBufferData(GL_ELEMENT_ARRAY_BUFFER, 3 * triangles_cnt * sizeof(int), model.getVertIndexes(), GL_STATIC_DRAW);
