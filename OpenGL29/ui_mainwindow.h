...
public:
    ...
    QSlider *verticalSliderShadowMap;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalSliderShadowMap = new QSlider(horizontalGroupBox);
        verticalSliderShadowMap->setObjectName(QString::fromUtf8("verticalSliderShadowMap"));
        verticalSliderShadowMap->setMinimum(1);
        verticalSliderShadowMap->setMaximum(600);
        verticalSliderShadowMap->setOrientation(Qt::Vertical);

        horizontalLayout_3->addWidget(verticalSliderShadowMap);


        gridLayout->addWidget(horizontalGroupBox, 0, 7, 2, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setText(QCoreApplication::translate("MainWindow", " Zapisz framebuffer ", nullptr));
        ...
        horizontalGroupBox->setTitle(QCoreApplication::translate("MainWindow", "Cienie", nullptr));
    } // retranslateUi
