...
public:
    ...
    QGroupBox *groupBoxFocus;
    QHBoxLayout *horizontalLayout_2;
    QSlider *verticalSliderDistance;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(horizontalSlider_Slider, 1, 0, 1, 3);
        ...
        verticalSliderLightB->setValue(250);
        ...
        gridLayout->addWidget(widgetOpenGL, 0, 0, 1, 3);

        groupBoxFocus = new QGroupBox(centralWidget);
        groupBoxFocus->setObjectName(QString::fromUtf8("groupBoxFocus"));
        sizePolicy.setHeightForWidth(groupBoxFocus->sizePolicy().hasHeightForWidth());
        groupBoxFocus->setSizePolicy(sizePolicy);
        horizontalLayout_2 = new QHBoxLayout(groupBoxFocus);
        horizontalLayout_2->setSpacing(6);
        horizontalLayout_2->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_2->setObjectName(QString::fromUtf8("horizontalLayout_2"));
        verticalSliderDistance = new QSlider(groupBoxFocus);
        verticalSliderDistance->setObjectName(QString::fromUtf8("verticalSliderDistance"));
        verticalSliderDistance->setMaximum(1000);
        verticalSliderDistance->setSliderPosition(300);
        verticalSliderDistance->setOrientation(Qt::Vertical);

        horizontalLayout_2->addWidget(verticalSliderDistance);

        verticalSliderRange = new QSlider(groupBoxFocus);
        verticalSliderRange->setObjectName(QString::fromUtf8("verticalSliderRange"));
        verticalSliderRange->setMinimum(1);
        verticalSliderRange->setMaximum(1000);
        verticalSliderRange->setSliderPosition(300);
        verticalSliderRange->setOrientation(Qt::Vertical);

        horizontalLayout_2->addWidget(verticalSliderRange);


        gridLayout->addWidget(groupBoxFocus, 0, 7, 2, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBoxFocus->setTitle(QCoreApplication::translate("MainWindow", "ostro\305\233\304\207", nullptr));
    } // retranslateUi
