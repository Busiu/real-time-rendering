...
public:
    ...
    void change_paralax_params(float min_layer, float max_layer, float height_scale);
...
protected:
    ...
    float min_layers, max_layers, height_scale;

    GLuint shaderProgram;
    GLuint VAO, VAO_light;
    GLuint tex_color, tex_normal, tex_depth;
