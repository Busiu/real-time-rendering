...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalSliderRotZ->setEnabled(true);
        ...
        groupBoxParalax = new QGroupBox(centralWidget);
        groupBoxParalax->setObjectName(QString::fromUtf8("groupBoxParalax"));
        horizontalLayout_6 = new QHBoxLayout(groupBoxParalax);
        horizontalLayout_6->setSpacing(6);
        horizontalLayout_6->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_6->setObjectName(QString::fromUtf8("horizontalLayout_6"));
        horizontalLayout_6->setContentsMargins(9, 9, 9, 9);
        minLayers = new QSlider(groupBoxParalax);
        minLayers->setObjectName(QString::fromUtf8("minLayers"));
        minLayers->setMinimum(1);
        minLayers->setMaximum(10);
        minLayers->setOrientation(Qt::Vertical);

        horizontalLayout_6->addWidget(minLayers);

        maxLayers = new QSlider(groupBoxParalax);
        maxLayers->setObjectName(QString::fromUtf8("maxLayers"));
        maxLayers->setMinimum(10);
        maxLayers->setMaximum(32);
        maxLayers->setOrientation(Qt::Vertical);

        horizontalLayout_6->addWidget(maxLayers);

        heightScale = new QSlider(groupBoxParalax);
        heightScale->setObjectName(QString::fromUtf8("heightScale"));
        heightScale->setMinimum(1);
        heightScale->setMaximum(128);
        heightScale->setOrientation(Qt::Vertical);

        horizontalLayout_6->addWidget(heightScale);


        gridLayout->addWidget(groupBoxParalax, 0, 7, 2, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBoxParalax->setTitle(QCoreApplication::translate("MainWindow", "Paralaksa", nullptr));
    } // retranslateUi
