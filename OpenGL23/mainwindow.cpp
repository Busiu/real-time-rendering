...
void MainWindow::change_paralax_params()
{
    ui->widgetOpenGL->change_paralax_params(ui->minLayers->value()*1.0,
                                            ui->maxLayers->value()*1.0,
                                            ui->heightScale->value()*0.001);
}

void MainWindow::on_minLayers_valueChanged(int)
{
    change_paralax_params();
}

void MainWindow::on_maxLayers_valueChanged(int)
{
    change_paralax_params();
}

void MainWindow::on_heightScale_valueChanged(int)
{
    change_paralax_params();
}
